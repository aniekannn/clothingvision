...
A clothing recognition system that can identify clothing items and their brands using computer vision and deep learning. Built with PyTorch and OpenCV, system is able to classify fashion items from camera input.
